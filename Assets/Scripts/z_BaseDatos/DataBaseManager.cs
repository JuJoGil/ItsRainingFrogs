...
public static class DataBaseManager {
    ...
    //DataBase name
    static string DBFileName = "BaseDeDatos.db";

    //Objeto que representa la conexion con la base de datos
    static IDbConnection dbConnection;
    //Comandod e abse de datos
    static IDbCommand dbCommand;
    static IDataReader reader;

    static string tableName1 = "Numero";
    static string tableName2 = "Table_2";
    static string columnName1 = "Cantidad";
    static string columnName2 = "column_2";


    public static int LoadValue1() {
        // Create the select statement.
        //Comando para leer los valores de la tabla
...
/*    public static int LoadValue2() {
    ...
    public static void SaveValue1(int coins) {
        // Create the update statement.
        //Comando que se le pasa a la base de datos
